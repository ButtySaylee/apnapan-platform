  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass p-8 space-y-8">
        <div>
          <p className="text-sm text-muted mb-4">{metric.description}</p>
          <div className="space-y-6">
          ...
          <div className="mt-6 p-4 bg-white/5 light:bg-slate-100 rounded-lg border border-white/10 light:border-slate-200">
            <p className="text-sm text-white light:text-slate-900">
              ...
              <br />
              <span className="text-xs text-muted mt-2 block">Same test scores. Different lived experience.</span>
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-2">
              {item.activities.map((activity, i) => (
                <div key={i} className="flex gap-2 text-sm">
                  ...
                  <span className="text-muted leading-relaxed">{activity}</span>
                </div>
              ))}
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="glass p-6 space-y-3 border border-slate-600/30">
          <p className="text-xs text-slate-400 font-semibold uppercase">Before Implementation</p>
          <p className="text-sm italic text-muted leading-relaxed">"{voice.quote}"</p>
          <div className="flex items-center gap-2 pt-3 border-t border-white/10">
            <span className="text-xs text-slate-500">{voice.school}</span>
          </div>
        </div>
        ...
        <div className="glass p-6 space-y-3 border-l-4 border-brand-teal bg-gradient-to-br from-brand-teal/5 to-brand-blue/5">
          ...
          <p className="text-sm italic text-muted leading-relaxed">"{voice.after}"</p>
          <div className="flex items-center justify-between pt-3 border-t border-white/10">
            <span className="text-xs text-muted">{voice.school}</span>
        ...
        <tbody>
          {outcomeData.map((row, idx) => (
            <tr key={idx} className="border-b border-white/10 light:border-slate-200 hover:bg-white/5 light:hover:bg-slate-100 transition-colors">
              ...
              <td className="py-3 px-4 text-right text-sm font-semibold text-slate-400">{row.traditional}%</td>
          ...
          <div className="container-wide flex items-center gap-4 py-4">
            <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 light:text-slate-600">School Partnership</p>
              </div>
            </Link>
        ...
        <main className="container-wide space-y-16 py-10">
              ...
              <div className="mt-8 p-6 glass rounded-lg border border-brand-teal/30">
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                  <div>
                    ...
                    <p className="text-xs text-muted">Belonging increase</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-white light:text-slate-900">12+</p>
                    <p className="text-xs text-muted">Schools transformed</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-white light:text-slate-900">89%</p>
                    <p className="text-xs text-muted">Predictive accuracy</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="space-y-8">
            ...
            {successStories.map((story, idx) => (
              <div key={idx} className="card-surface p-8 space-y-6">
                <div className="grid gap-4 md:grid-cols-[2fr_1fr]">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted">{story.location} • {story.studentCount.toLocaleString()} students</p>
          ...
          <section className="card-surface p-8 space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-3 p-6 bg-slate-500/5 light:bg-slate-400/10 rounded-lg border border-slate-500/30">
                <h4 className="font-bold text-slate-300 light:text-slate-700">We might not be a fit if:</h4>
                <ul className="space-y-2">
                  {[
          ...
          <section className="card-surface p-8 space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {[
                ...
                <div key={idx} className="space-y-3 p-6 glass rounded-lg">
