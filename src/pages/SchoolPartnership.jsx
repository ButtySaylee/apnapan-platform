          ...
          <div className="container-wide flex items-center gap-2 sm:gap-4 py-3 sm:py-4">
            <Link to="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <p className="hidden sm:block text-xs" style={{ color: theme === 'dark' ? '#64748b' : '#94a3b8' }}>School Partnership</p>
              </div>
            </Link>
            ...
            <Link
              to="/login"
              className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 mr-2 sm:mr-4 rounded-lg text-xs sm:text-sm font-semibold transition-all"
              style={{
