        ...
        <header className="sticky top-0 z-20 border-b" style={{
          ...
          <div className="container-wide flex items-center gap-4 py-4">
            <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                <h1 className="text-lg font-semibold" style={{ color: theme === 'dark' ? '#f1f5f9' : '#0f172a' }}>Educator Dashboard</h1>
                <p className="text-xs" style={{ color: theme === 'dark' ? '#64748b' : '#94a3b8' }}>{userData.name}</p>
              </div>
            </Link>
